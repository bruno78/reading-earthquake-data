...
public class EarthQuakeClient {
    ...
    public void quakesOfDepth() {
        ...
        String source = "data/nov20quakedata.atom";
        ArrayList<QuakeEntry> list = parser.read(source);
        ArrayList<QuakeEntry> quakeDepthData = filterByDepth(list, -4000.0, -2000.0);
    ...
    public void quakesByPhrase(){
        ...
        String source = "data/nov20quakedata.atom";
        ArrayList<QuakeEntry> list = parser.read(source);
        ArrayList<QuakeEntry> quakePh1 = filterByPhrase(list, "start", "Quarry Blast");
        ArrayList<QuakeEntry> quakePh2 = filterByPhrase(list, "end", "Alaska");
        ArrayList<QuakeEntry> quakePh3 = filterByPhrase(list, "any", "Can");
        
        for(QuakeEntry qe : quakePh1){
            System.out.println(qe);
        }
        System.out.println("Found " + quakePh1.size() + " quakes that match Quarry Blast at start");
        System.out.println("");
        for(QuakeEntry qe : quakePh2){
            System.out.println(qe);
        }
        System.out.println("Found " + quakePh2.size() + " quakes that match Alaska at end");
        System.out.println("");
        for(QuakeEntry qe : quakePh3){
            System.out.println(qe);
        }
        System.out.println("Found " + quakePh3.size() + " quakes that match Can at any");
        System.out.println("");
    }
